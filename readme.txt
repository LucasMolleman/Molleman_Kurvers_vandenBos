...
- A .zip file ("LIONESS_BEAST.zip") containing the code for the experimental task, developed in LIONESS Lab (see lioness-lab.org), including a READ ME Word file with instructions to get the BEAST running on your own server in a few simple steps.
