...
- A .zip file ("LIONESS_BEAST.zip") containing the code for the experimental task, developed in LIONESS Lab (see lioness-lab.org), including instructions to get it running on your own server in a few simple steps.
